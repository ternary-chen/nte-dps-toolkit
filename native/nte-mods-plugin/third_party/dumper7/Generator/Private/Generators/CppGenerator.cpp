...
public:
	...
	TDelegate.Properties =
	{
		PredefinedMember{
			...
			.Type = "static_assert(!std::is_same_v<FunctionSignature, FunctionSignature>, \"TDelegate should be used with a function signature. Something might be wrong in the SDK-Generator.\")", .Name = "", .Offset = 0x0, .Size = 0x10, .ArrayDim = 0x0, .Alignment = 0x8,
			.bIsStatic = true, .bIsZeroSizeMember = true, .bIsBitField = false, .BitIndex = 0xFF
		},
	};
	...
	TMulticastInlineDelegate.Properties =
	{
		PredefinedMember{
			.Comment = "Validity Check",
			.Type = "static_assert(!std::is_same_v<FunctionSignature, FunctionSignature>, \"TMulticastInlineDelegate should be used with a function signature. Something might be wrong in the SDK-Generator.\")", .Name = "", .Offset = 0x0, .Size = 0x10, .ArrayDim = 0x0, .Alignment = 0x8,
			.bIsStatic = true, .bIsZeroSizeMember = true, .bIsBitField = false, .BitIndex = 0xFF
		},
	};
