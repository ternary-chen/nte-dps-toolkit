...
void Settings::Config::Load()
{
	...
	char SDKPath[256] = {};
	GetPrivateProfileStringA("Settings", "SDKGenerationPath", "", SDKPath, sizeof(SDKPath), ConfigPath);
	...
	if (SDKPath[0] != '\0')
	{
		try
		{
			...
			if (!ec) 
			{
				...
				Settings::Generator::SDKGenerationPath = SDKCanonicalPath;
			}
		}
		catch (const std::filesystem::filesystem_error& fe)
		{
			...
			std::cerr << "Falling back to default path: " << Settings::Generator::SDKGenerationPath << "\n";
		}
	}
